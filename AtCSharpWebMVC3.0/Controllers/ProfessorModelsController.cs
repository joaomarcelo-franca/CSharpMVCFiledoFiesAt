...
namespace AtCSharpWebMVC3._0.Controllers
{
    public class ProfessorModelsController : Controller
    {
        ...
        public ProfessorModelsController(AtCSharpWebMVC3_0Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProfessorModel != null ? 
                          ...
                          Problem("Entity set 'AtCSharpWebMVC3_0Context.ProfessorModel'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Materia")] ProfessorModel professorModel)
        {
            ...
            {
                professorModel.DataDeCriacao = DateTime.Now;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AtCSharpWebMVC3_0Context.ProfessorModel'  is null.");
            }
            var professorModel = await _context.ProfessorModel.FindAsync(id);
            if (professorModel != null)
            {
